                    ...
                    parameters=[
                        {
                            ...
                            "upload_after_alarm_count": monitor.get("upload_after_alarm_count", 2),
                            "reset_alarm_count_after_upload": monitor.get("reset_alarm_count_after_upload", True),
                            "alarm_count_reset_timeout_seconds": monitor.get("alarm_count_reset_timeout_seconds", 30),
